...
public class ArtistJdbcTemplateRepository implements ArtistRepository {
    ...
    public Artist createArtist(Artist artist) {
        ...
        parameters.put("profile", artist.getProfile());
        parameters.put("description", artist.getDescription());
...
//        jdbcTemplate.update("update artist SET name = ?, profile = ?, description =? where id = ?",
//                artist.getName(), artist.getProfile(), artist.getDescription());
//    }
